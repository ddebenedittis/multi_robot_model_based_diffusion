...
J2 = sp.Matrix.hstack(z0.cross(p2 - p0).col_join(z0), z1.cross(p2 - p1_full).col_join(z1), sp.zeros(6, 2))
rG2 = T02_com[:3, :3]
...
J3 = sp.Matrix.hstack(z0.cross(p3 - p0).col_join(z0), z1.cross(p3 - p1_full).col_join(z1), z2.col_join(sp.zeros(3, 1)), sp.zeros(6, 1))
rG3 = T03_com[:3, :3]
...
J4 = sp.Matrix.hstack(z0.cross(p4 - p0).col_join(z0), z1.cross(p4 - p1_full).col_join(z1), z2.col_join(sp.zeros(3, 1)), z3.cross(p4 - p3_full).col_join(z3))
rG4 = T04_com[:3, :3]

...
states = np.load("results/rrpr_states_over_steps.npz", allow_pickle=True)['states']
...
ani.save("results/rrpr_all_ee_trajs.mp4", fps=3)
print("Video saved: results/rrpr_all_ee_trajs.mp4")
